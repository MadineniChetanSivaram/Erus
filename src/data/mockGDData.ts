...
export const INITIAL_SLOTS: GDSession[] = [
  ...
  },
  {
    ...
    currentPhase: 'intro',
    facilitatorSpeech: 'Good morning participants of Slot 2. Today we debate whether AI can substitute teachers in higher education. Discussion commences once started by Faculty In-Charge.',
    facilitatorAction: 'Waiting for Faculty In-Charge to commence session',
    isFacilitatorSpeaking: false,
    silenceTimerSeconds: 0,
    currentSpeakerId: null,
  ...
  },
  {
    ...
    currentPhase: 'intro',
    facilitatorSpeech: 'Welcome to Slot 3. The floor will be open once started by the Faculty In-Charge.',
    facilitatorAction: 'Waiting for Faculty In-Charge to commence session',
    isFacilitatorSpeaking: false,
    silenceTimerSeconds: 0,
    currentSpeakerId: null,
  ...
  },
  {
    ...
    assessmentRubric: 'Standard Academic 7-Parameter Rubric',
    status: 'waiting',
    students: generateSlotParticipants(14),
    currentPhase: 'intro',
    facilitatorSpeech: 'Welcome to Slot 4 (Evening). The floor will be open once started by the Faculty In-Charge.',
    facilitatorAction: 'Waiting for Faculty In-Charge to commence session',
    isFacilitatorSpeaking: false,
    silenceTimerSeconds: 0,
    currentSpeakerId: null,
